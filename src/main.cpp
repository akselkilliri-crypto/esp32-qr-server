...
// OLED на аппаратном I2C (GPIO21=SDA, GPIO22=SCL)
#include <GyverOLED.h>
GyverOLED<SSD1306_128x64> oled; // с буфером, по умолчанию I2C
...
void setup() {
    ...
    // Инициализация OLED (без проверки — init() возвращает void)
    oled.init();
    ...
    Serial.println("BLE QR Server ready");
}
